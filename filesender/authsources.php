...
$config = [
    ...
    */
    ...
    'ldap' => [
        ...
        'hostname' => getenv('SAML_IDP_LDAP_HOSTNAME'), //'ldap.example.org',

        // Whether SSL/TLS should be used when contacting the LDAP server.
        'enable_tls' => getenv('SAML_IDP_LDAP_TLS') == 'true', //true,
        ...
        // The default is 389.
        'port' => intval(getenv('SAML_IDP_LDAP_PORT')), //389,

        // Set whether to follow referrals. AD Controllers may require FALSE to function.
        'referrals' => getenv('SAML_IDP_LDAP_REFERRALS') == 'true', //true,
        ...
        'search.base' => getenv('SAML_IDP_LDAP_SEARCH_BASE'),//'ou=people,dc=example,dc=org',

        // The attribute(s) the username should match against.
        //
        // This is an array with one or more attribute names. Any of the attributes in
        // the array may match the value the username.
        'search.attributes' => [getenv('SAML_IDP_LDAP_SEARCH_ATTRIBUTE')], //['uid', 'mail'],
        ...
        'search.username' => getenv('SAML_IDP_LDAP_SEARCH_USERNAME'), //null,
        'search.password' => getenv('SAML_IDP_LDAP_SEARCH_PASSWORD'), //null,
